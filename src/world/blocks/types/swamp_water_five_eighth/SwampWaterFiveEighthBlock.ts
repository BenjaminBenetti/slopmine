...
export class SwampWaterFiveEighthBlock extends TransparentBlock {
  ...
  protected get defaultTextureId(): number {
    return TextureId.SWAMP_WATER_FIVE_EIGHTH
  }
