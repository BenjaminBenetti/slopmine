...
registerTextureUrl(TextureId.SWAMP_WATER_HALF, swampWaterTexUrl, true)
...
export class SwampWaterHalfBlock extends TransparentBlock {
  ...
  protected get defaultTextureId(): number {
    return TextureId.SWAMP_WATER_HALF
  }
