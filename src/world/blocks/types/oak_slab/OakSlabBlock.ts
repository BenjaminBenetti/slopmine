...
// Reuse the oak planks texture (registered in the atlas by the planks block module)
...
/**
 * Oak slab - half-height block occupying the bottom of its cell.
 */
export class OakSlabBlock extends SolidBlock {
  readonly properties: IBlockProperties = {
    id: BlockIds.OAK_SLAB,
    name: 'oak_slab',
    isOpaque: false,
    isSolid: true,
    isLiquid: false,
