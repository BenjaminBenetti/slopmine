...
// Reuse the redwood planks texture (registered by the planks block module)
...
const redwoodChairMaterial = new THREE.MeshLambertMaterial({ map: redwoodPlanksTexture })
...
/**
 * Redwood chair - seat with four legs and a backrest, open toward +Z (front).
 * Uses the redwood planks texture. Facing rotation via placement metadata.
 */
export class RedwoodChairBlock extends SolidBlock {
  readonly properties: IBlockProperties = {
    id: BlockIds.REDWOOD_CHAIR,
    name: 'redwood_chair',
    isOpaque: false,
    isSolid: true,
    isLiquid: false,
  ...
  getDrops(): IItem[] {
    return [new RedwoodChairBlockItem()]
  }
}
