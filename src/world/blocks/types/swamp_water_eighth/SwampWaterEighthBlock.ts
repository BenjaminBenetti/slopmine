...
export class SwampWaterEighthBlock extends TransparentBlock {
  ...
  protected get defaultTextureId(): number {
    return TextureId.SWAMP_WATER_EIGHTH
  }
