...
registerTextureUrl(TextureId.SWAMP_WATER_QUARTER, swampWaterTexUrl, true)
...
export class SwampWaterQuarterBlock extends TransparentBlock {
  ...
  protected get defaultTextureId(): number {
    return TextureId.SWAMP_WATER_QUARTER
  }
