...
export class SwampWaterThreeEighthBlock extends TransparentBlock {
  ...
  protected get defaultTextureId(): number {
    return TextureId.SWAMP_WATER_THREE_EIGHTH
  }
