...
export const stonePickaxeRecipe: IRecipe = {
  id: 'stone_pickaxe',
  name: 'Stone Pickaxe',
  ingredients: [{ tag: ItemTags.STONE, count: 3 }, { itemId: 'stick', count: 2 }],
...
export const stoneShovelRecipe: IRecipe = {
  id: 'stone_shovel',
  name: 'Stone Shovel',
  ingredients: [{ tag: ItemTags.STONE, count: 1 }, { itemId: 'stick', count: 2 }],
...
export const stoneAxeRecipe: IRecipe = {
  id: 'stone_axe',
  name: 'Stone Axe',
  ingredients: [{ tag: ItemTags.STONE, count: 2 }, { itemId: 'stick', count: 2 }],
