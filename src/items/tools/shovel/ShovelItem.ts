 ...
 * Shovels get bonus damage on dirt-tagged blocks.
 */
export abstract class ShovelItem extends ToolItem {
  ...
  /** Damage multiplier vs dirt blocks - override in variants */
  protected abstract readonly dirtMultiplier: number

  get toolStats(): IToolStats {
    return {
      demolitionForce: this.tier,
      damage: this.baseDamage,
      damageMultipliers: new Map([[BlockTags.DIRT, this.dirtMultiplier]]),
    }
  }
}
