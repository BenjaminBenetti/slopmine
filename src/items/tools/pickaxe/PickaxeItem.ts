 ...
 * Pickaxes get bonus damage on rock-tagged blocks.
 */
export abstract class PickaxeItem extends ToolItem {
  ...
  /** Damage multiplier vs rock blocks - override in variants */
  protected abstract readonly rockMultiplier: number

  get toolStats(): IToolStats {
    return {
      demolitionForce: this.tier,
      damage: this.baseDamage,
      damageMultipliers: new Map([[BlockTags.ROCK, this.rockMultiplier]]),
    }
  }
}
